...
export class CognitoUtil {
    ...
    getUserPool() {
        if (cognitoCongf.cognito_idp_endpoint) {
            CognitoUtil._POOL_DATA.endpoint = cognitoCongf.cognito_idp_endpoint;
        }
    ...
    buildCognitoCreds(idTokenJwt: string) {
        ...
        if (cognitoCongf.cognito_identity_endpoint) {
            serviceConfigs.endpoint = cognitoCongf.cognito_identity_endpoint;
        }
